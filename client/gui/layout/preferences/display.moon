        ...
        {
            {
                ...
                width: 330
                index: 5
                -- { value: { 800, 480},  text:  "800 x 480 (5:3)"    }
                -- { value: { 800, 600},  text:  "800 x 600 (4:3)"    }
                -- { value: { 960, 540},  text:  "960 x 540 (16:9)"   }
                -- { value: {1024, 600},  text: "1024 x 600 (16:9)"   }
            ...
            }
            {
                ...
                {
                    {
                        id: "mode_desktop", type: 'radio', group: 'fullscreen_type'
                        text: 'Desktop', status: "borderless fullscreen windowed"
                    }
                    {
                        id: "mode_exclusive", type: 'radio', group: 'fullscreen_type'
